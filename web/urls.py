...
custom_patterns.append( url(r'^arcana/', include('codes.web.arcana.urls')))
...
custom_patterns.append( url(r'^orders/', include('codes.web.orders.urls')))
...
custom_patterns.append( url(r'^spells/', include('codes.web.spells.urls')))
