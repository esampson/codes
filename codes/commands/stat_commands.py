...
class CmdInfo(Command):
    ...
    narrow the search. Class also supports partial name matching.
...
def produce_sheet(target):
    ...
    block1 = ['  Intelligence:'
              ...
              + '      Presence:' + str(target.presence()).rjust(2)
              + ' ', '          Wits:' + str(target.wits()).rjust(2)
              + '  Dexterity:' + str(target.dexterity()).rjust(2)
              + '  Manipulation:' + str(target.manipulation()).rjust(2)
              + ' ', '       Resolve:' + str(target.resolve()).rjust(2)
              + '    Stamina:' + str(target.stamina()).rjust(2)
              + '     Composure:' + str(target.composure()).rjust(2) + ' ']

    # build the Skill block
    block2 = ['     Academics:' + str(target.academics()).rjust(2)
              + '  Athletics:' + str(target.athletics()).rjust(2)
              + '    Animal Ken:' + str(target.animal_ken()).rjust(2)
              + ' ', '      Computer:' + str(target.computer()).rjust(2)
              + '      Brawl:' + str(target.brawl()).rjust(2)
              + '       Empathy:' + str(target.empathy()).rjust(2)
              + ' ', '        Crafts:' + str(target.crafts()).rjust(2)
              + '      Drive:' + str(target.drive()).rjust(2)
              + '    Expression:' + str(target.expression()).rjust(2)
              + ' ', ' Investigation:' + str(target.investigation()).rjust(2)
              + '   Firearms:' + str(target.firearms()).rjust(2)
              + '  Intimidation:' + str(target.intimidation()).rjust(2)
              + ' ', '      Medicine:' + str(target.medicine()).rjust(2)
              + '    Larceny:' + str(target.larceny()).rjust(2)
              + '    Persuasion:' + str(target.persuasion()).rjust(2)
              + ' ', '        Occult:' + str(target.occult()).rjust(2)
              + '    Stealth:' + str(target.stealth()).rjust(2)
              + '     Socialize:' + str(target.socialize()).rjust(2)
              + ' ', '      Politics:' + str(target.politics()).rjust(2)
              + '   Survival:' + str(target.survival()).rjust(2)
              + '    Streetwise:' + str(target.streetwise()).rjust(2)
              + ' ', '       Science:' + str(target.science()).rjust(2)
              + '   Weaponry:' + str(target.weaponry()).rjust(2)
              + '    Subterfuge:' + str(target.subterfuge()).rjust(2) + ' ']
    ...
    if target.template().lower() == 'changeling':
        ...
        if frailties != -1 and frailties is not False:
            if len(frailties) != 0:
                sub_block = ['Frailties:']
        ...
        if obsessions != -1 and obsessions is not False:
            if len(obsessions) != 0:
    ...
    if target.template().lower() == 'vampire':
        ...
        if banes != -1 and banes is not False:
            if len(banes) != 0:
                sub_block = ['Banes:']
                for item in banes:
                    for line in textwrap.wrap(item, width=24,
