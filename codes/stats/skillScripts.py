...
class skillScript(Script):
    ...
    def meets_prereqs(self, target, value=0, subentry=''):
        ...
        Determines if a character meets the prerequisites to purchase a skill. Should
    ...
    def set(self, target, value, subentry=''):
        ...
        Sets the value of a skill on a character sheet. Adds the skill if the
