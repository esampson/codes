...
class DevotionScript(CodesScript):
    ...
    def get(self, target, subentry=''):
        ...
        Determines if a character has a given devotion. Should only
    ...
    def meets_prereqs(self, target, value=0, subentry=''):
        ...
        devotion. Should only return True or False.
    ...
    def set(self, target, value, subentry=''):
        ...
        Sets the value of a devotion on a character sheet if value is
        True. Removes the devotion if the value is False.
        ...
        if name not in target.db.devotions and value is True:
            target.db.devotions[name] = True
            result = True
        elif name in target.db.devotions and value is False:
            del target.db.devotions[name]
            result = True
        elif name not in target.db.devotions and value is False:
            result = True
        else:
            result = True
        return result
